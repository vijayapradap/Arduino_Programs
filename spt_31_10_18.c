...
unsigned char gps=0, gsm=0, gsm_flag=0, rec=0;
char n_s='N', e_w='E';
...
char customer_number[11]={"8124255031"};
...
void main()
{
    ...
    while(1)
    {
        ...
        integer_lat=(int)Lat3;
        fract_int_lat=((int)(Lat3*10000)%10000);
        ...
        integer_long=(int)Long3;
        fract_int_long=((int)(Long3*10000)%10000);
        ...
        if(strstr(Location,"00.") || strstr(Location,"000."))
        {
